...
1. **In the VM**, install the proper JRE/JAVA version. We recommend [Zulu](https://www.azul.com/downloads/?version=java-21-lts&package=jre#zulu). **As of plugin 1.9.0, you will need Java 21 or higher.**

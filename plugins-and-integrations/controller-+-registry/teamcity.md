...
**IMPORTANT:** As of 1.11.0, our plugin will install the Teamcity Build Agent for you into the VM Template/Tag under the path specified in your Cloud Profile.

1. **In the VM**, install the proper JRE/JAVA version. We recommend [Zulu](https://www.azul.com/downloads/?version=java-21-lts&package=jre#zulu). **As of plugin 1.11.0, you will need Java 21 or higher.**

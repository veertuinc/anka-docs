...
- [Anka Build Cloud Controller should be configured and running before your Anka Node can join.]({{< archRelRef "Anka Build Cloud/_index.md" >}})

- [Your Node should be licensed.]({{< archRelRef "Licensing/_index.md" >}})

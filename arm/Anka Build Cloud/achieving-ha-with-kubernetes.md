...
Once it's up and running, you can [join your nodes to the Controller load balancer IP/hostname.]({{< relref "arm/Anka Build Cloud/Joining Nodes with Controller" >}})

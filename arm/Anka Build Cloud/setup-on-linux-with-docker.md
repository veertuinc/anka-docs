...
{{< include file="_partials/arm/Getting Started/partials/_what-we-are-doing.md" >}}
...
{{< include file="_partials/arm/Getting Started/partials/_controller-listening-on-80-and-orientation.md" >}}
...
Check out the variables under the `environment` section of each service. [A full reference is available.]({{< relref "arm/Anka Build Cloud/configuration-reference.md" >}})
...
{{< include file="_partials/arm/Getting Started/partials/_add-the-registry.md" >}}

### Push the VM to the Registry

{{< include file="_partials/arm/Getting Started/partials/_push-vm-to-registry.md" >}}

### Join to the Controller & Registry

{{< include file="_partials/arm/Getting Started/partials/_join-to-cluster.md" >}}

## Step 4: Start a VM instance using the Controller UI

{{< include file="_partials/arm/Getting Started/partials/_start-vm-instance-using-controller-ui.md" >}}
...
- Find out how to use the [Controller REST API]({{< relref "arm/Anka Build Cloud/working-with-controller-and-api.md#api">}}).  
- Learn how to work with [USB devices]({{< relref "arm/Anka Virtualization/working-with-usb-devices.md">}})
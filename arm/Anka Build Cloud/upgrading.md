...
{{< hint info >}}
We recommend [snapshotting your etcd database]({{< relref "arm/Anka Build Cloud/setup-on-linux-with-docker.md#etcd-snapshotting" >}}) regularly, but especially before an upgrade.
{{< /hint >}}

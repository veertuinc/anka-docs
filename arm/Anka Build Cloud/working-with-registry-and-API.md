...
Anka registry provides an easy way to store, version, and distribute macOS VMs that are used for CI and development. Once you've completed creation and setup of your VMs, use [`anka registry`]({{< relref "arm/Anka Virtualization/command-reference.md#registry" >}}) command to work with the registry.  

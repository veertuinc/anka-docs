...
If any of your Nodes has the message `Inactive (Invalid License)` under it's state, you need to go to that Node and activate the license. You can find more information about Anka License commands [here]({{< relref "arm/Anka Virtualization/command-reference.md" >}}#manage-anka-license).

...
> You can find a list of configuration options in the [Configuration Reference]({{< relref "arm/Anka Build Cloud/configuration-reference.md" >}}) by searching for `ANKA_OIDC`
...
{{< include file="arm/Anka Build Cloud/Advanced Security Features/partials/_managing-permissions.md" >}}

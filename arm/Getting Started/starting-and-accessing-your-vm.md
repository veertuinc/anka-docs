...
> **Catalina and lower:** When running [`anka run`]({{< relref "arm/Anka Virtualization/command-reference.md#run" >}}) with no options/flags, it will mount the current directory from the host into the VM and execute commands in this mounted location. This can be disabled using the [`-n`]({{< relref "arm/Anka Virtualization/command-reference.md#run" >}}) option.

> **Big Sur:** When running [`anka run`]({{< relref "arm/Anka Virtualization/command-reference.md#run" >}}) with no options/flags, the current directory will not be mounted in by default. This requires the [manual installation of addons]({{< relref "arm/Anka Virtualization/command-reference.md#install-addons">}}).
...
> The [`anka run`]({{< relref "arm/Anka Virtualization/command-reference.md#run" >}}) command doesn't source .profile or .bash_profile. You have to source the file before executing other commands
...
- [Port forwarding of VM ports is supported]({{< relref "arm/Anka Virtualization/command-reference.md#example---add-port-forwarding" >}})

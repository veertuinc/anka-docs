...
To create a VM from `.iso`, you will use [`anka create`]({{< relref "arm/Anka Virtualization/command-reference.md#create" >}}) command as you typically would. It will create an empty VM.

...
{{< include file="_partials/anka-build-cloud/configuration-reference/controller/authenticationandauthorization/notice.md" >}}
...
| ANKA_ENABLE_INSTANCE_QUOTAS | (boolean) | Enable licensed authorization-group instance quota enforcement (requires authentication).) | false |

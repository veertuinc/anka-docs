...
❯ anka show 12.1.0-arm | grep status
| status  | stopped Oct 19 07:34:43 2021         |

❯ anka run 12.1.0-arm hostname
12-0-beta.local

❯ anka show 12.1.0-arm | grep status
| status  | running since Oct 19 07:34:59 2021   |

❯ anka run 12.1.0-arm bash -c "env"           
SHELL=/bin/zsh
...
❯ TEST=123 anka run -e TEST 12.1.0-arm bash -c "env | grep TEST && echo \${TEST}"
TEST=123
123

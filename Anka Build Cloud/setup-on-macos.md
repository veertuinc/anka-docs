...
For Anka CLI commands and options, see the [Command Reference]({{< relref "intel/command-line-reference.md" >}}).
...
> You can find detailed instructions for [`anka create`]({{< relref "intel/command-line-reference.md#create" >}}) [here.]({{< relref "intel/Getting Started/creating-your-first-vm.md" >}})
...
- [Prepare and join your machines to the Build Cloud]({{< relref "Anka Build Cloud/preparing-and-joining-your-nodes.md" >}}).  
- Browse the [Anka CLI Command Reference]({{< relref "intel/command-line-reference.md" >}}).  
...
- Learn how to work with [USB devices]({{< relref "intel/working-with-usb-devices.md">}})

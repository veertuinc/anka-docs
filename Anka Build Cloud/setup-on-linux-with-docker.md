...
{{< include file="shared/Getting Started/partials/_what-we-are-doing.md" >}}
...
For Anka CLI commands and options, see the [Command Reference]({{< relref "Anka Virtualization/command-reference.md" >}}).

## Obtain the macOS installer

{{< include file="shared/Getting Started/partials/_obtain-macos-installer.md" >}}
...
> You can find detailed instructions for [`anka create`]({{< relref "Anka Virtualization/command-reference.md#create" >}}) [here.]({{< relref "Getting Started/creating-your-first-vm.md" >}})
...
{{< include file="shared/Getting Started/partials/_controller-listening-on-80-and-orientation.md" >}}
...
Check out the variables under the `environment` section of each service. [A full reference is available.]({{< relref "Anka Build Cloud/configuration-reference.md" >}})
...
{{< include file="shared/Getting Started/partials/_add-the-registry.md" >}}

### Push the VM to the Registry

{{< include file="shared/Getting Started/partials/_push-vm-to-registry.md" >}}

### Join to the Controller & Registry

{{< include file="shared/Getting Started/partials/_join-to-cluster.md" >}}

## Step 4: Start a VM instance using the Controller UI

{{< include file="shared/Getting Started/partials/_start-vm-instance-using-controller-ui.md" >}}
...
- Browse the [Anka CLI Command Reference]({{< relref "Anka Virtualization/command-reference.md" >}}).  
- Connect the cloud to your [CI software]({{< relref "CI Plugins and Integrations/_index.md" >}}).  
- Find out how to use the [Controller REST API]({{< relref "Anka Build Cloud/working-with-controller-and-api.md#api">}}).  
- Learn how to work with [USB devices]({{< relref "Anka Virtualization/working-with-usb-devices.md">}})
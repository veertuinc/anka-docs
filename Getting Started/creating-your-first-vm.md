...
{{< include file="shared/Getting Started/partials/_supported-macos-versions.md" >}}

{{< include file="shared/Getting Started/partials/_obtain-macos-installer.md" >}}

> As an alternative to the macOS installer, [you can also use an iso]({{< relref "Anka Virtualization/creating-a-vm-template-with-an-iso.md" >}})
...
{{< include file="./shared/Getting Started/partials/_understanding-templates-and-tags.md" >}}
...
- [Starting and Accessing your VM]({{< relref "Getting Started/starting-and-accessing-your-vm.md" >}})

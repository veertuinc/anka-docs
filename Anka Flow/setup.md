...
Anka when activated with the Anka Flow license enables installation of Anka package on the developer mac machines. It enables the developers to create and work inside Anka macOS VMs on their local machines. Developers can use the [`anka run`]({{< relref "Anka Virtualization/command-reference.md#run" >}}) interface to work inside Anka VMs in a container like manner.  
...
1. Follow the [official installation guide]({{< relref "Getting Started/installing-the-anka-virtualization-package.md" >}})

...
Once configured, [you can use the API to list or delete/regenerate the MAC list from a new range]({{< archRelRef "Anka Build Cloud/working-with-controller-and-API.md#mac-addresses-management" >}}).
...
A full list of options is available in the [configuration reference]({{< archRelRef "Anka Build Cloud/configuration-reference.md#tls" >}}).

...
> If you're using the Enterprise Plus license, [you will need to setup authorization for your certificate]({{< relref "intel/Anka Build Cloud/Advanced Security Features/certificate-authentication.md#managing-usergroup-permissions-authorization" >}})
...
> Beginning in Controller version 1.12.0, [you can control the allowed TLS Cipher Suites and minimum/maximum TLS versions]({{< relref "intel/Anka Build Cloud/configuration-reference.md#tls" >}})
...
- You may notice that the Controller UI doesn't load or acts strangely. You will need to enable [Root Token Authentication]({{< relref "intel/Anka Build Cloud/Advanced Security Features/root-token-authentication.md" >}}) to access the controller UI.

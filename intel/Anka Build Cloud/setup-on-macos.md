...
#### Configuration and scripts ([reference]({{< relref "intel/Anka Build Cloud/command-reference.md" >}}))
...
> You can modify the destination in the `/usr/local/bin/anka-controllerd` file ([reference]({{< relref "intel/Anka Build Cloud/command-reference.md#logging" >}})).
...
> The log level can be modified from the default 0 value. The higher the number, the more verbose the logging. ([reference]({{< relref "intel/Anka Build Cloud/command-reference.md#logging" >}}))

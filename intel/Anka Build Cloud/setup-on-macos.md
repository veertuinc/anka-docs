...
#### Configuration and scripts ([reference]({{< relref "intel/Anka Build Cloud/configuration-reference.md" >}}))
...
> You can modify the destination in the `/usr/local/bin/anka-controllerd` file ([reference]({{< relref "intel/Anka Build Cloud/configuration-reference.md#logging" >}})).

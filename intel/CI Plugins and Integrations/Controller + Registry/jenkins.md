...
> In order to follow these instructions, you will need to [install the Anka CLI]({{< archRelRef "Getting Started/installing-the-anka-virtualization-package.md" >}}) and an understanding of how to [start the VM]({{< archRelRef "Anka Virtualization/command-reference.md#start" >}}) and [launch the viewer]({{< archRelRef "Anka Virtualization/command-reference.md#view" >}}).

...
2. On the host, enable [port forwarding]({{< archRelRef "Anka Virtualization/command-reference.md#modify" >}}) of the VM's 22 port using the Anka CLI. _We recommend not specifying `--host-port`._

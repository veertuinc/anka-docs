...
2. On the host, enable [port forwarding]({{< relref "intel/Anka Virtualization/command-reference.md#example---add-port-forwarding" >}}) for your VM Template using the Anka CLI. _We recommend not specifying `--host-port`._
...
![gitlab runner attached](/anka/images/ci-plugins-and-integrations/admin-panel-runners.png)

...
6. The Anka Cloud can't run VMs (see [VM is stuck at scheduling]({{< relref "docs/Anka Build Cloud/Troubleshooting Guides and Logs/guides/anka-build-cloud/controller/vm-stuck-scheduling.md">}}))
...
> If your VM does **not** start try to [troubleshoot it]({{< relref "docs/Anka Build Cloud/Troubleshooting Guides and Logs/guides/anka-build-cloud/controller/vm-stuck-scheduling.md">}}) 
...
You can find more information on how set up port forwarding [here]({{< ref "docs/Getting Started/creating-your-first-vm.md" >}}#automated-methods)

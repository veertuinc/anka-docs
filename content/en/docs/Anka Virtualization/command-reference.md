...
{{< include file="./shared/content/en/docs/Anka Virtualization/partials/modify/name/_index.md" >}}
### modify {vmNameOrUUID} cpu
{{< include file="./shared/content/en/docs/Anka Virtualization/partials/modify/cpu/_index.md" >}}
### modify {vmNameOrUUID} ram
{{< include file="./shared/content/en/docs/Anka Virtualization/partials/modify/ram/_index.md" >}}
### modify {vmNameOrUUID} network
{{< include file="./shared/content/en/docs/Anka Virtualization/partials/modify/network/_index.md" >}}
### modify {vmNameOrUUID} disk
{{< include file="./shared/content/en/docs/Anka Virtualization/partials/modify/disk/_index.md" >}}
### modify {vmNameOrUUID} display
{{< include file="./shared/content/en/docs/Anka Virtualization/partials/modify/display/_index.md" >}}
## View
...
## Push
{{< include file="./shared/content/en/docs/Anka Virtualization/partials/push/_index.md" >}}
## Pull
{{< include file="./shared/content/en/docs/Anka Virtualization/partials/pull/_index.md" >}}
## Suspend
...
### registry revert
{{< include file="./shared/content/en/docs/Anka Virtualization/partials/registry/revert/_index.md" >}}
## Cp
...
#### license show k,key
{{< include file="./shared/content/en/docs/Anka Virtualization/partials/license/show/k,key/_index.md" >}}
### license activate
{{< include file="./shared/content/en/docs/Anka Virtualization/partials/license/activate/_index.md" >}}
### license delete
{{< include file="./shared/content/en/docs/Anka Virtualization/partials/license/delete/_index.md" >}}
### license accept-eula
